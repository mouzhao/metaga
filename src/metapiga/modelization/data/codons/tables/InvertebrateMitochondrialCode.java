...
public class InvertebrateMitochondrialCode extends CodonTransitionTable
{
    ...
    public InvertebrateMitochondrialCode() {
        ...
        this.isoleucine = EnumSet.of(Codon.ATT, Codon.ATC);
        this.methionine = EnumSet.of(Codon.ATG, Codon.ATA);
        this.valine = EnumSet.of(Codon.GTT, Codon.GTC, Codon.GTA, Codon.GTG);
        this.serine = EnumSet.of(Codon.TCT, Codon.TCC, Codon.TCA, Codon.TCG, Codon.AGA);
