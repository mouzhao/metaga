...
public class CDHNuclearCode extends CodonTransitionTable
{
    ...
    public CDHNuclearCode() {
        this.stopCodons = EnumSet.of(Codon.TGA);
        ...
        this.glutamine = EnumSet.of(Codon.CAA, Codon.CAG, Codon.TAA, Codon.TAG);
        ...
        this.opal = EnumSet.of(Codon.TGA);
        this.tryptophan = EnumSet.of(Codon.TGG);
